...
/**
 * 銀行振込決済情報入力画面 のページクラス.
 *
 * @package Page
 */
class LC_Page_Mdl_XYZ_BankTransfer extends LC_Page {
    ...
    function makeParam() {
        ...
        // 決済手段区分
        $arrParam['bill_method'] = MDL_XYZ_BANK_TRANSFER_BILL_METHOD;

        // 決済種類コード。
        $arrParam['kessai_id'] = MDL_XYZ_BANK_TRANSFER_KESSAI_ID;
